        ...
        <div className="w-full max-w-md">
          <RevealBlock>
            ...
            <div className="mt-6 text-center text-sm text-text-muted sm:mt-8">
              Don't have an account? <Link href={returnTo ? `/signup?returnTo=${encodeURIComponent(returnTo)}` : "/signup"} className="text-gold hover:text-text-main transition-colors">Sign up</Link>
            </div>
          </RevealBlock>
        </div>
      </main>
