...
from app.schemas.product import ProductImageCreate, ProductImageRead, ProductImageUpdate
...
@router.post("/product/{product_id}", response_model=SuccessResponse[ProductImageRead])
async def add_image(product_id: int, payload: ProductImageCreate, session: DatabaseDep):
